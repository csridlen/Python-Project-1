...
- [Traffic Crashes](data/crashes_data_dictionary.csv)
- [Census](data/chicago_census_data_dictionary.csv )
- [Arrest](data/PublicReleaseArrestData_data_dictionary.csv)
