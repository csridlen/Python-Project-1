...
crash_data_dictionary.to_csv("data/crashes_data_dictionary.csv", index=False)
...
census_data_dictionary.to_csv("data/chicago_census_data_dictionary.csv", index=False)
...
arrest_dict = {
    ...
    "Description": [
        "chicago police district where arrest took place",
...
arrest_data_dictionary.to_csv(
    "data/PublicReleaseArrestData_data_dictionary.csv", index=False
)
